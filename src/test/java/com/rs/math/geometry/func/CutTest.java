...
public class CutTest {
    ...
    public void testBorder1() {
        ...
        Segment s9 = new Segment(p1, px);

        Graph graph = new Graph(Arrays.asList(s1, s2, s3, s4, s5, s6, s7, s8, s9));
    ...
    public void testBorder2() {
        ...
        Graph graph = new Graph(Arrays.asList(s1, s2, s3, s4, s5));
        Polygon border = Cut.border(graph);
    ...
    public void testBorder3() {
        ...
        Segment s1 = new Segment(p1, p5);
        Segment s2 = new Segment(p5, p2);
        Segment s3 = new Segment(p2, p3);
        Segment s4 = new Segment(p3, p4);
